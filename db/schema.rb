...
ActiveRecord::Schema.define(version: 20171103112056) do
  ...
  create_table "favorite_genres", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["genre_id"], name: "index_favorite_genres_on_genre_id", using: :btree
    t.index ["user_id"], name: "index_favorite_genres_on_user_id", using: :btree
  end
